...
$_lang['pdotools_prop_ajaxElemWrapper'] = 'CSS-селектор элемента-обёртки с результатами и пагинацией.';
$_lang['pdotools_prop_ajaxElemRows'] = 'CSS-селектор элемента с результатами.';
$_lang['pdotools_prop_ajaxElemPagination'] = 'CSS-селектор элемента с пагинацией.';
$_lang['pdotools_prop_ajaxElemLink'] = 'CSS-селектор ссылки на страницу.';
$_lang['pdotools_prop_ajaxElemMore'] = 'CSS-селектор кнопки загрузки результатов при ajaxMode = button.';
