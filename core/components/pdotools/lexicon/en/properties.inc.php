...
$_lang['pdotools_prop_ajaxElemWrapper'] = 'CSS selector for wrapper element with the results and pagination.';
$_lang['pdotools_prop_ajaxElemRows'] = 'CSS selector for element with results.';
$_lang['pdotools_prop_ajaxElemPagination'] = 'CSS selector for element with pagination.';
$_lang['pdotools_prop_ajaxElemLink'] = 'CSS selector for pagination links.';
$_lang['pdotools_prop_ajaxElemMore'] = 'CSS selector for "load more" button in ajaxMode = button.';
